...
func testSetup() []func() {
	...
	confStrings := []string{
		...
		"SomeVolume.MaxEntriesPerDirNode=32",
		"SomeVolume.MaxExtentsPerFileNode=32",
		"SomeVolume.MaxInodesPerMetadataNode=32",
		"SomeVolume.MaxLogSegmentsPerMetadataNode=64",
		"SomeVolume.MaxDirFileNodesPerMetadataNode=16",
		"SomeVolume2.FSID=2",
		...
		"SomeVolume2.MaxEntriesPerDirNode=32",
		"SomeVolume2.MaxExtentsPerFileNode=32",
		"SomeVolume2.MaxInodesPerMetadataNode=32",
		"SomeVolume2.MaxLogSegmentsPerMetadataNode=64",
		"SomeVolume2.MaxDirFileNodesPerMetadataNode=16",
