...
type SMBConfig struct {
	...
	// NOTE: The rest of this struct creates globals used within
	// the template.
	AdCommentStr   string
	AdIDCommentStr string
}
...
func TestParser(t *testing.T) {
	...
	pattern := filepath.Join("testData", "smb_conf.tmpl")

	// Here starts the example proper.
	// Load the drivers.
	tplate, err := template.ParseGlob(pattern)
	if err != nil {
	...
	// Execute the template for each SMB configuration
	for _, c := range mySMB {
