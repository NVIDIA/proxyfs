...
allow_read_only = {
    ...
    "Server.RpcGetObject",
    "Server.RpcGetStatPath",
    "Server.RpcGetStat",
    "Server.RpcGetXAttrPath",
    "Server.RpcGetXAttr",
    "Server.RpcHead",
    "Server.RpcIsAccountBimodal",
    "Server.RpcListXAttrPath",
    "Server.RpcListXAttr",
    "Server.RpcLookupPath",
    "Server.RpcLookup",
    "Server.RpcMountByAccountName",
    "Server.RpcMountByVolumeName",
    "Server.RpcPing",
    "Server.RpcReadSymlinkPath",
...
allow_read_write = {
    ...
    "Server.RpcChown",
    "Server.RpcCoalesce",
    "Server.RpcCreateContainer",
    "Server.RpcCreatePath",
    "Server.RpcCreate",
    "Server.RpcDelete",
    "Server.RpcFetchExtentMapChunk",
    "Server.RpcFlock",
    ...
    "Server.RpcMountByVolumeName",
    "Server.RpcPing",
    "Server.RpcPutComplete",
    "Server.RpcPutContainer",
    ...
    "Server.RpcRemoveXAttrPath",
    "Server.RpcRemoveXAttr",
    "Server.RpcRenamePath",
    "Server.RpcRename",
    ...
    "Server.RpcSetstat",
    "Server.RpcStatVFS",
    "Server.RpcSymlinkPath",
    "Server.RpcSymlink",
    "Server.RpcType",
    "Server.RpcUnlinkPath",
    "Server.RpcUnlink",
    "Server.RpcWrote",
}
