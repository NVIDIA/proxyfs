...
func (vS *volumeStruct) Coalesce(containingDirInodeNumber InodeNumber, combinationName string, elements []CoalesceElement) (combinationInodeNumber InodeNumber, attrChangeTime time.Time, modificationTime time.Time, numWrites uint64, size uint64, err error) {
