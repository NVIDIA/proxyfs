...
func usage() {
	fmt.Println("go run make_static.go -?")
	fmt.Println("   Prints this help text")
	fmt.Println("go run make_static.go <packageName> <contentName> <contentType> <contentFormat> <srcFile> <dstFile.go>")
...
func main() {
	...
	_, err = dstFile.Write([]byte(fmt.Sprintf("// Code generated by \"go run make_static.go %v %v %v %v %v %v\" - DO NOT EDIT\n\n", packageName, contentName, contentType, contentFormat, srcFileName, dstFileName)))
	if nil != err {
		panic(err.Error())
	}
